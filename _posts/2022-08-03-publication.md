...
1. Jaehyun Nam, Seungsoo Lee, Phillip Porras, Vinod Yegneswaran, and Seungwon Shin, "Secure Inter-Container Communications using XDP/eBPF", IEEE/ACM Transactions on Networking (ToN), 2022.

1. Jaehyun Nam, Seung Ho Na, Seungwon Shin, and Taejune Park, “Reconfigurable Regular Expression Matching Architecture for Real-time Pattern Update and Payload Inspection”, Journal of Network and Computer Applications(JNCA), 2022.
